...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>clikt.version</b>
     * <p>
     ...
     * with version reference <b>datetime.version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     ...
     * with version reference <b>json.version</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class SupabaseLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>postgres</b> with <b>io.github.jan-tennert.supabase:postgrest-kt</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getPostgres() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("supabase.postgres");
        }
         ...
         * with version reference <b>supabase.storage</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final CliktVersionAccessors vaccForCliktVersionAccessors = new CliktVersionAccessors(providers, config);
        ...
        private final SupabaseVersionAccessors vaccForSupabaseVersionAccessors = new SupabaseVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>pdfbox</b> with value <b>2.0.24</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>slf4jNop</b> with value <b>2.0.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSlf4jNop() { return getVersion("slf4jNop"); }

        /**
         * Version alias <b>supabaseBom</b> with value <b>3.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.clikt</b>
         */
        public CliktVersionAccessors getClikt() {
            return vaccForCliktVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.datetime</b>
         */
        public DatetimeVersionAccessors getDatetime() {
        ...
        /**
         * Group of versions at <b>versions.supabase</b>
         */
        public SupabaseVersionAccessors getSupabase() {
            return vaccForSupabaseVersionAccessors;
        }

    }

    public static class CliktVersionAccessors extends VersionFactory  {

        public CliktVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>clikt.version</b> with value <b>4.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("clikt.version"); }
    ...
    public static class DatetimeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>datetime.version</b> with value <b>0.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("datetime.version"); }
    ...
    public static class JsonVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>json.version</b> with value <b>1.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlin.version</b> with value <b>2.0.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinxCoroutinesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinx.coroutines.test</b> with value <b>1.6.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KtorVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ktor.client</b> with value <b>3.0.0-rc-1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class SerializationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>serialization.version</b> with value <b>1.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class SupabaseVersionAccessors extends VersionFactory  {

        public SupabaseVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>supabase.storage</b> with value <b>0.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStorage() { return getVersion("supabase.storage"); }
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>serialization.version</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
